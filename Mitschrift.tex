...
\begin{example}
	\begin{enumerate}
		...
		\item Die Theorie $\acf_p$ mit $p=0$ oder $p$ eine Primzahl ist nicht $\aleph_0$-kategorisch, aber schmal. Betrachte dazu insbesondere $\bar{\setQ} \not\simeq \bar{\setQ(\pi)}$
...
\section{Fra"isses Amalgamierungsmethode f"ur $\aleph_0$-kategorische Theorien}
\begin{definition}
	...
	\begin{enumerate}
		...
		\end{equation*}
		\item[AP]\label{AP}\footnote{amalgumation property} F"ur alle Diagramme aus $\fK$ %TODO Diragramme einf"ugen
...
\begin{definition}\label{reich}
	...
	\begin{equation*}
		\fK \underset{\substack{\text{bis auf}\\\text{Isomorphie}}}{=} \{\scrA \underset{\text{US}}{\subset}\scrM, \scrA~ \text{endlich erzeugt} \}
	\end{equation*}
