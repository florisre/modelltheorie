...
\begin{proof}
	...
	$\varphi = \exists y \psi[x_1, \dots, x_n, y]$: $\scrA \models \varphi[a_1, \dots, a_n] \Rightarrow$ es gibt ein $a \in A$ sodass $\scrA \models \psi[a_1, \dots, a_n, a] \\
	\underset{\ref{tarksi:bew}}{\Rightarrow} \scrB \models \psi[a_1, \dots, a_n, a]$ f"ur ein $a in A \subset B \Rightarrow \scrB \models \varphi[a_1, \dots, a_n]$
...
\end{corollary}
\begin{proof}
	Wir beweisen induktiv "uber dern Aufbau von $\varphi=\varphi[x_1, \dots, x_n]$, dass f"ur alle $i \in I$, f"ur alle $a_1, \dots, a_n \in A_i$: $\scrA_i \models \varphi[a_1, \dots, a_n] \Leftrightarrow \scrA \models \varphi[a_1, \dots, a_n]$.
	...
	$\varphi = \exists y \psi[x_1, \dots, x_n, y]$: $\scrA_i\models \varphi[a_1, \dots, a_n] \Rightarrow$ es gint ein $a \in A_i$ mit $\scrA_i\models \psi[a_1, \dots,a_n, a] \\
...
\begin{definition}
	Eine Theorie $T$ hat Quantorenelemination, falls jede $\scrL$-Formel $\varphi[x_1, \dots, x_n]$ "aquivalent modulo $T$ zu einer quantorenfreien $\scrL$-Formel $\psi[x_1, \dots, x_n]$ ist.
	\begin{equation*}
...
\begin{example}
	...
	Die diese Formel ist in $\scrL$ nicht "aquivalent zu einer quantorenfreien Formel, in $\scrL_1 \coloneqq (\setR, 0, 1, +, -, \cdot, <)$ hingegen doch. Somit ist die Menge in $\scrL_1$ quantorenfrei.
\end{example}
\end{document}