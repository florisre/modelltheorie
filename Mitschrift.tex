...
\begin{definition}\label{reich}
	...
	\end{equation*}
	und f"ur jede endlich erzeugte Unterstruktur $\scrA \subset \scrM$ und $\scrA \underset{f}{\hookrightarrow} \scrB \in \fK$ gint es ein $\scrB' \underset{\text{US}}{\subset} \scrM$ endlich erzeugt, welches $\scrA$ enth"alt und
	\begin{equation*}
...
\end{remark}
\begin{proof}
	Sei $\scrB \in \fK$ beliebig. %TODO Bild zeichnen
\end{proof}
\end{document}