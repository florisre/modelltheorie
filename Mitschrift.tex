...
\begin{proof}
	...
	Es gibt eine Menge $\left(b_\alpha\right)_{\alpha<\aleph_1}$ von Realisierungen verschiedener Typen "uber $A$ (in $\scrM$). Wegen L"owenheim-Skolem abw"arts %TODO Referenz
	...
	Wegen L"owenheim-Skolem aufw"arts %TODO Referenz
...
\begin{proof}
	...
	Wegen L"owenheim Skolem auf- und abw"arts %TODO Referenz
...
\begin{proof}
	...
	\hin $T~\kappa$-kategorisch $\Rightarrow$ %TODO Referenz zu Korollar kappa-kategorisch ==> omega-stabil
