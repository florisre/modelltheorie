...
\begin{lemma}[Tarskis Test]\label{test}
...
\begin{example}
	...
	%Straight Lines [id:da629687830632755] 
	\draw    (245.45,150.27) -- (196.82,206.39) ;
...
\begin{example}[Nicht-Beispiel]
	...
	%Straight Lines [id:da9921736906430345] 
	\draw    (195.14,180.57) -- (285.75,250.36) ;
...
\begin{proof}
	...
	%Straight Lines [id:da9921736906430345] 
	\draw    (164.77,180.57) -- (228.93,250.36) ;
...
\end{proof}
\begin{example}
	$\setQ^{(\omega)}$ ist $\aleph_0$-saturiert. Insbesondere werden alle Typen in $\setQ^{(\omega)}$ realisiert, siehe dazu \autoref{im:typq}.
	\begin{figure}
		\centering
		\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
...
\end{remark}
\begin{proof}
	Betrachte \autoref{im:kartoffel:1}.
	...
	\end{tikzpicture}
	\caption{Erweitern einer elementaren Abbildung $f_\alpha$}
	\label{im:kartoffel:1}
	\end{figure}
...
\end{corollary}
\begin{proof}
	\underline{"`$\Rightarrow$"':} $\scrM, \scrN_0$ seien $\aleph_0$-saturiert.\\ Betrachte hierzu auch \autoref{im:kartoffel:2}.
...
\end{proof}
\begin{example} \label{ex:aek}
	$T$, $\scrL = \{P_n\}_{n\in \setN}$. Jedes $P_n$ unendlich, $P_n$ \& $P_m$ disjunkt. Was ist das $\aleph_0$-saturierte Modell? Betrachte dazu \autoref{im:saturiert}.
	...
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=.9]
	%uncomment if require: \path (0,300); %set diagram left start at 0, and has height of 300
	...
	\end{tikzpicture}
	\caption{schematische Darstellung des $\aleph_0$-saturierten Modells von $T$}
	\label{im:saturiert}
	\end{figure}
...
%Sitzung 17 17.12.19
\begin{definition}
	Sei $T$ eine abz"ahlbare konsistente Theorie mit unendlichen Modellen und $\kappa \geq \aleph_0$ eine Kardinalzahl.\\
	$T$ ist $\kappa$-kategorisch, falls $T$ ein einziges Modell (bis auf Isomorphie) der M"achtigkeit $\kappa$ besitzt.
\end{definition}
\begin{remark}
	Wenn $T$ $\kappa$-kategorisch ist, dann ist $T$ vollst"andig.
\end{remark}
\begin{proof}
	Betrachte das Diagramm in \autoref{im:strukturen}:
	\begin{figure}
		\centering
		\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
	...
	%Straight Lines [id:da7940474216775021] 
	\draw    (386.08,169.99) -- (386.08,272.39) ;
	
	
	%Straight Lines [id:da9369625772003937] 
	\draw    (177.44,169.99) -- (177.44,272.39) ;
	
	
	%Straight Lines [id:da48543810631839635] 
	\draw    (86.65,118.79) -- (111.76,272.39) ;
	
	
	%Straight Lines [id:da3302134146080793] 
	\draw    (460.45,118.79) -- (440.17,272.39) ;
	
	
	%Straight Lines [id:da6463580423446773] 
	\draw    (111.76,85.76) -- (440.17,85.76) ;
	
	
	%Straight Lines [id:da5125665414453157] 
	\draw    (172,109) -- (104.92,128.44) ;
	\draw [shift={(103,129)}, rotate = 343.84000000000003] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	
	%Straight Lines [id:da10079505355942986] 
	\draw    (391,109) -- (442.13,128.29) ;
	\draw [shift={(444,129)}, rotate = 200.67000000000002] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	
	
	% Text Node
	\draw (177.44,145.22) node   [align=left] {$\displaystyle \mathcal{M}$};
	% Text Node
	\draw (386.08,145.22) node   [align=left] {$\displaystyle \mathcal{N}$};
	% Text Node
	\draw (144.6,272.39) node   [align=left] {$\displaystyle \mathcal{M}_{0}$};
	% Text Node
	\draw (413.12,272.39) node   [align=left] {$\displaystyle \mathcal{N}_{0}$};
	% Text Node
	\draw (86.65,85.76) node   [align=left] {$\displaystyle \tilde{\mathcal{M}}$};
	% Text Node
	\draw (460.45,85.76) node   [align=left] {$\displaystyle \tilde{\mathcal{N}}$};
	% Text Node
	\draw (202.9,221.19) node  [rotate=-270.78] [align=left] {$\displaystyle \preceq $};
	% Text Node
	\draw (360.62,221.19) node  [rotate=-270.78] [align=left] {$\displaystyle \preceq $};
	% Text Node
	\draw (144.6,316.98) node   [align=left] {abz"ahlbar};
	% Text Node
	\draw (413.12,316.98) node   [align=left] {abz"ahlbar};
	% Text Node
	\draw (468.76,221.19) node  [rotate=-278.51] [align=left] {$\displaystyle \preceq $};
	% Text Node
	\draw (81.44,221.19) node  [rotate=-256.7] [align=left] {$\displaystyle \preceq $};
	% Text Node
	\draw (281,256.5) node   [align=left] {L"owenheim-Skolem abw"arts};
	% Text Node
	\draw (279.5,75.29) node   [align=left] {$\displaystyle \simeq $};
	% Text Node
	\draw (279,109) node   [align=left] {L"owenheim-Skolem aufw"arts};
...
\begin{example}
	$T = \setQ$-Vektorraum. $S_1 (T): \begin{array}{r}
		(x \dot=0)\\
		\lnot(x \dot= 0)
	\end{array}$, aber $S_n (T): \underbrace{(x \dot= \lambda y)}_{\text{unendlich viele M"oglichkeiten}}$. Vgl. dazu: %TODO welche Aufgabe war das?
...
\begin{proof}
	...
	\end{equation*}
	wobei wir jeweils alle $1$-Typen auf endlichen Teilmengen betrachten und diese im nachfolgenden Modell realisieren\footnote{Vergleiche dazu auch "Ubung xyz}%TODO auf "Ubung "uber Fasern verweisen
...
\end{proof}
\begin{proof}[Korrekter Beweis \nameref{2M}] \label{korrekt}
...
\begin{definition}
	Sei $\scrL$ eine abz"ahlbare Sprache. Eine Klasse $\fK$ von endlich erzeugten abz"ahlbaren $\scrL$-Strukturen ist eine \emph{Fra"issé-Klasse}, falls $\fK$ bis auf Isomorphie abz"ahlbar ist und folgende Eigenschaften besitzt:
	\begin{enumerate}
		...
		\draw (189,214) node    {$C$};
		% Connection
		\draw    (171.5,196.5) -- (124.41,149.41) ;
		\draw [shift={(123,148)}, rotate = 405] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		\draw [shift={(171.5,196.5)}, rotate = 225] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,0) .. controls (-3.09,0) and (-5.59,2.5) .. (-5.59,5.59) .. controls (-5.59,8.68) and (-3.09,11.18) .. (0,11.18) ;
		% Connection
		\draw    (206.5,196.5) -- (255.09,147.91) ;
		\draw [shift={(256.5,146.5)}, rotate = 495] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		\draw [shift={(206.5,196.5)}, rotate = 315] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
		
		\end{tikzpicture}
				
		gibt es ein $D \in \fK$ sodass folgendes Diagramm kommutiert:
		...
		\tikzset{
			...
			pattern radius = 1pt}
		\makeatletter
		\pgfutil@ifundefined{pgf@pattern@name@_69touon2z}{
			\pgfdeclarepatternformonly[\mcThickness,\mcSize]{_69touon2z}
			{\pgfqpoint{0pt}{0pt}}
		...
		%Shape: Square [id:dp6965169202297804] 
		\draw  [pattern=_69touon2z,pattern size=6pt,pattern thickness=0.75pt,pattern radius=0pt, pattern color={rgb, 255:red, 0; green, 0; blue, 0}][line width=0.75]  (179.5,126.5) -- (198.5,126.5) -- (198.5,145.5) -- (179.5,145.5) -- cycle ;
		...
		\draw [shift={(206.5,196.5)}, rotate = 315] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
		% Connection
		\draw    (131,116) -- (176.09,70.91) ;
		\draw [shift={(177.5,69.5)}, rotate = 495] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		\draw [shift={(131,116)}, rotate = 315] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
		% Connection
		\draw    (248.5,117.5) -- (201.91,70.91) ;
		\draw [shift={(200.5,69.5)}, rotate = 405] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		\draw [shift={(248.5,117.5)}, rotate = 225] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,0) .. controls (-3.09,0) and (-5.59,2.5) .. (-5.59,5.59) .. controls (-5.59,8.68) and (-3.09,11.18) .. (0,11.18) ;
...
\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
	...
	%Shape: Ellipse [id:dp8024736529934057] 
	\draw   (95.5,147.5) .. controls (95.5,100.28) and (119.45,62) .. (149,62) .. controls (178.55,62) and (202.5,100.28) .. (202.5,147.5) .. controls (202.5,194.72) and (178.55,233) .. (149,233) .. controls (119.45,233) and (95.5,194.72) .. (95.5,147.5) -- cycle ;
	
	% Text Node
	\draw (80,63) node   [align=left] {$\displaystyle \mathcal{M}$};
	% Text Node
	\draw (319,211) node   [align=left] {$\displaystyle \mathcal{B}$};
	% Text Node
	\draw (251,153) node   [align=left] {$\displaystyle \mathcal{D}$};
	% Text Node
	\draw (149,191) node   [align=left] {$\displaystyle \mathcal{A}$};
	% Text Node
	\draw (149,103) node   [align=left] {$\displaystyle \mathcal{B} '$};
	% Text Node
	\draw (130.73,211) node  [rotate=-315.15]  {$=$};
	% Text Node
	\draw (91,250) node    {$\underbrace{\langle \{a\} \rangle _{\mathcal{M}}}_{\in \mathfrak{K}}$};
	% Connection
	\draw    (231.5,143.44) -- (163.3,110.01) ;
	\draw [shift={(161.5,109.13)}, rotate = 386.11] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(231.5,143.44)}, rotate = 206.11] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,0) .. controls (-3.09,0) and (-5.59,2.5) .. (-5.59,5.59) .. controls (-5.59,8.68) and (-3.09,11.18) .. (0,11.18) ;
	% Connection
	\draw    (169,183.55) -- (237.63,157.98) ;
	\draw [shift={(239.5,157.28)}, rotate = 519.5699999999999] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(169,183.55)}, rotate = 339.57] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,0) .. controls (-3.09,0) and (-5.59,2.5) .. (-5.59,5.59) .. controls (-5.59,8.68) and (-3.09,11.18) .. (0,11.18) ;
	% Connection
	\draw    (300.5,195.22) -- (264.02,164.11) ;
	\draw [shift={(262.5,162.81)}, rotate = 400.46000000000004] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(300.5,195.22)}, rotate = 220.46] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,0) .. controls (-3.09,0) and (-5.59,2.5) .. (-5.59,5.59) .. controls (-5.59,8.68) and (-3.09,11.18) .. (0,11.18) ;
	
	\end{tikzpicture}

	
	%TODO Inklusionspfeile
\end{proof}

%Sitzung 19 7.1.2020
\begin{lemma}
	Je zwei abz"ahlbare $\fK$-reiche Strukturen sind isomorph.
\end{lemma}
\begin{proof}
	Konstruiere ein Back-\&-Forth-System.
	...
	%Shape: Ellipse [id:dp18022197532417028] 
	\draw   (45,146.5) .. controls (45,102.04) and (70.3,66) .. (101.5,66) .. controls (132.7,66) and (158,102.04) .. (158,146.5) .. controls (158,190.96) and (132.7,227) .. (101.5,227) .. controls (70.3,227) and (45,190.96) .. (45,146.5) -- cycle ;
	%Shape: Ellipse [id:dp1425239474162091] 
	\draw   (255,146.5) .. controls (255,102.04) and (280.3,66) .. (311.5,66) .. controls (342.7,66) and (368,102.04) .. (368,146.5) .. controls (368,190.96) and (342.7,227) .. (311.5,227) .. controls (280.3,227) and (255,190.96) .. (255,146.5) -- cycle ;
	
	% Text Node
	\draw (32,65) node    {$\mathcal{M}$};
	% Text Node
	\draw (244.5,65) node    {$\mathcal{N}$};
	% Text Node
	\draw (91,193) node    {$A$};
	% Text Node
	\draw (67,249) node   [align=left] {endlich erzeugt};
	% Connection
	\draw    (85.86,205) -- (72.36,236.5) ;
	
	
	
	\end{tikzpicture}\\
	$A \in \fK = \{B \underset{\text{US}}{\subset} \scrN~ \text{endlich erzeugt} \}$. Also: Es gibt ein $B \underset{\text{US}}{\subset} \scrN, A \simeq B$. $\hookrightarrow$ Das Back-\&-Forth-System ist nicht leer.
	...
	%Shape: Ellipse [id:dp1425239474162091] 
	\draw   (255,146.5) .. controls (255,102.04) and (280.3,66) .. (311.5,66) .. controls (342.7,66) and (368,102.04) .. (368,146.5) .. controls (368,190.96) and (342.7,227) .. (311.5,227) .. controls (280.3,227) and (255,190.96) .. (255,146.5) -- cycle ;
	%Shape: Circle [id:dp7448220146587021] 
	\draw   (85,173.5) .. controls (85,164.39) and (92.39,157) .. (101.5,157) .. controls (110.61,157) and (118,164.39) .. (118,173.5) .. controls (118,182.61) and (110.61,190) .. (101.5,190) .. controls (92.39,190) and (85,182.61) .. (85,173.5) -- cycle ;
	%Shape: Circle [id:dp2642626825335065] 
	\draw   (295,176.5) .. controls (295,167.39) and (302.39,160) .. (311.5,160) .. controls (320.61,160) and (328,167.39) .. (328,176.5) .. controls (328,185.61) and (320.61,193) .. (311.5,193) .. controls (302.39,193) and (295,185.61) .. (295,176.5) -- cycle ;
	%Shape: Ellipse [id:dp025019120005968065] 
	\draw   (295,176.5) .. controls (295,155.86) and (335.52,139.13) .. (385.5,139.13) .. controls (435.48,139.13) and (476,155.86) .. (476,176.5) .. controls (476,197.14) and (435.48,213.88) .. (385.5,213.88) .. controls (335.52,213.88) and (295,197.14) .. (295,176.5) -- cycle ;
	%Shape: Ellipse [id:dp6331978609963701] 
	\draw   (276.5,140.5) .. controls (276.5,111.51) and (292.17,88) .. (311.5,88) .. controls (330.83,88) and (346.5,111.51) .. (346.5,140.5) .. controls (346.5,169.49) and (330.83,193) .. (311.5,193) .. controls (292.17,193) and (276.5,169.49) .. (276.5,140.5) -- cycle ;
	%Curve Lines [id:da24163138547803142] 
	\draw    (422,179) .. controls (429.96,125.27) and (382.48,78.47) .. (312.56,111.5) ;
	\draw [shift={(311.5,112)}, rotate = 334.25] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(422,179)}, rotate = 278.43] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,0) .. controls (-3.09,0) and (-5.59,2.5) .. (-5.59,5.59) .. controls (-5.59,8.68) and (-3.09,11.18) .. (0,11.18) ;
	...
	\draw (244.5,65) node    {$\mathcal{N}$};
	% Text Node
	\draw (101.5,201) node    {$A$};
	% Text Node
	\draw (110.5,114) node    {$c$};
	% Text Node
	\draw (207,146.5) node  [font=\Huge]  {$\simeq $};
	% Text Node
	\draw (311.5,207) node    {$B$};
	% Text Node
	\draw (435,90) node   [align=left] {$\displaystyle h_{1}$ Einbettung};
	% Text Node
	\draw (524,251) node    {$ \begin{array}{l}
		D\ \simeq \langle A,c\rangle ,\ B\ \leftarrow A,\ \\
		h:\langle A,c\rangle \longrightarrow D\ \text{ein} \ \mathcal{L}\text{\mbox{-}Isomorphismus}\\
		\Rightarrow D\ \in \mathfrak{K}
		\end{array}$};
...
\begin{proof}[Beweis des Satzes]
	Wir konstruieren eine Kette $\scrM_n \subset \scrM_{n+1}$, wobei mit "`$\subset$"' lediglich die Existenz einer Einbettung gemeint ist, keine tats"achliche Teilmenge, von Elementen aus $\fK$ derart, dass f"ur jedes $n \in \setN$ gilt:
	...
	% Text Node
	\draw (16,106) node    {$\mathcal{M}_{n}$};
	% Text Node
	\draw (45,132) node  [rotate=-48.73]  {$\underset{\text{US}}{\subset }$};
	% Text Node
	\draw (71,152) node    {$A$};
	% Text Node
	\draw (191,152.02) node    {$B\ \in \mathfrak{K}$};
	% Text Node
	\draw (263,152.02) node  [font=\LARGE]  {$\Rightarrow $};
	% Text Node
	\draw (407,53) node   [align=left] {es existiert ein $\displaystyle n\leq k\ \in \mathbb{N}$ mit};
	% Text Node
	\draw (317,106) node    {$\mathcal{M}_{n}$};
	% Text Node
	\draw (372,196) node    {$A$};
	% Text Node
	\draw (463,152.02) node    {$B\ $};
	% Text Node
	\draw (328,164.02) node   [align=left] {US};
	% Text Node
	\draw (409,77) node    {$\mathcal{M}_{k}$};
	% Text Node
	\draw (475,106) node   [align=left] {"uber $\displaystyle A$};
	% Connection
	\draw    (89.5,152) -- (162,152.02) ;
	\draw [shift={(164,152.02)}, rotate = 180.01] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(89.5,152)}, rotate = 0.01] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (324.94,119) -- (364.67,184) ;
	
	
	% Connection
	\draw    (390.5,187.06) -- (449.7,158.45) ;
	\draw [shift={(451.5,157.58)}, rotate = 514.21] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(390.5,187.06)}, rotate = 334.21] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (342.5,97.96) -- (390.59,82.8) ;
	\draw [shift={(392.5,82.2)}, rotate = 522.5] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(342.5,97.96)}, rotate = 342.5] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (448.6,132.02) -- (419.53,91.62) ;
	\draw [shift={(418.36,90)}, rotate = 414.25] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(448.6,132.02)}, rotate = 234.25] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,0) .. controls (-3.09,0) and (-5.59,2.5) .. (-5.59,5.59) .. controls (-5.59,8.68) and (-3.09,11.18) .. (0,11.18) ;
	
	\end{tikzpicture}
	\\Wir konstruieren $\scrM_n, H_n\underbrace{(k)}_{k \geq n} \in \fK$ so, dass:
	\begin{enumerate}
		\item $\scrM_n \subset \scrM_{n+1} = H_n(n)$
		\item $\scrM_n \subseteq H_n(k) \underbrace{\subseteq}_{\substack{\text{wenn es Sinn}\\\text{macht}~(k \geq n+1)}} H_{n+1}(k)$
		\item $\scrM_n \underset{\text{US}}{\supset} A \hookrightarrow B \Rightarrow~$es existiert $k\geq n$ mit $B \hookrightarrow \scrM_k$ "uber $A$ eingebettet
	\end{enumerate}

	F"ur (2): \underline{$n=0$:} $\rightarrow$ sei $\scrM_0 \in \fK$ beliebig. Setze $H_0(k) = \scrM_0$ f"ur alle $k$.
	
	F"ur (1): \underline{$n \rightarrow n+1$:} Angenommen $\scrM_n$ und $H_n(k), k \geq n$ wurden bereits konstruiert. Betrachte nun alle endlich erzeugten Unterstrukturen von $\scrM_n$ und jeweils alle Erweiterungen.
	...
	% Text Node
	\draw (25,94) node    {$\mathcal{M}_{n}$};
	% Text Node
	\draw (45,132) node  [rotate=-48.73]  {$\underset{\substack{\text{endl. erz.} \\\text{US}}}{\supset }$};
	% Text Node
	\draw (71,152) node    {$A_{k}$};
	% Text Node
	\draw (203,112.02) node    {$B_{k}$};
	% Text Node
	\draw (50,196.02) node  [font=\LARGE]  {$\underset{\text{wegen AP}}{\Rightarrow }$};
	% Text Node
	\draw (238,42) node   [align=left] {$\displaystyle k\ \geq n+1$};
	% Text Node
	\draw (85,288) node    {$\mathcal{M}_{n}$};
	% Text Node
	\draw (140,378) node    {$A$};
	% Text Node
	\draw (239,346.02) node    {$B\ $};
	% Text Node
	\draw (177,259) node    {$H_{n}( k)$};
	% Text Node
	\draw (155,146) node    {$f_{n,k}$};
	% Text Node
	\draw (124,57) node    {$H_{n}( k)$};
	% Text Node
	\draw (69,77) node  [rotate=-335.96]  {$\subseteq $};
	% Text Node
	\draw (121,334) node  [rotate=-52.91] [align=left] {$\displaystyle \supseteq $};
	% Text Node
	\draw (129,276) node  [rotate=-332.17]  {$\subseteq $};
	% Text Node
	\draw (313,250) node    {$H_{n+1}( k)$};
	% Text Node
	\draw (393,181) node   [align=left] {es gibt nur abz"ahlbar viele M"oglichkeiten};
	% Text Node
	\draw (199,379) node    {$f_{n,k}$};
	% Text Node
	\draw (335,339) node   [align=left] {kommutiert};
	% Connection
	\draw    (93,145.34) -- (188.59,116.39) ;
	\draw [shift={(190.5,115.81)}, rotate = 523.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(93,145.34)}, rotate = 343.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (158.5,372.02) -- (225.6,350.35) ;
	\draw [shift={(227.5,349.74)}, rotate = 522.1] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(158.5,372.02)}, rotate = 342.1] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (51.05,83.93) -- (42.5,87.24) ;
	
	
	% Connection
	\draw    (86.95,70.47) -- (99.5,65.91) ;
	
	
	% Connection
	\draw    (254.41,326.02) -- (301.76,264.58) ;
	\draw [shift={(302.98,263)}, rotate = 487.62] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(254.41,326.02)}, rotate = 307.62] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (209.5,256.85) -- (280,252.18) ;
	\draw [shift={(282,252.05)}, rotate = 536.21] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(209.5,256.85)}, rotate = 356.21] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	
	\end{tikzpicture}
	
	Wir wollen noch (3) zeigen:
	...
	\draw (25,94) node    {$\mathcal{M}_{n}$};
	% Text Node
	\draw (45,132) node  [rotate=-48.73]  {$\underset{\text{endl. erz. \\US}}{\supset }$};
	% Text Node
	\draw (71,152) node    {$A$};
	% Text Node
	\draw (203,112.02) node    {$B$};
	% Text Node
	\draw (134,197) node   [align=left] {$\displaystyle \Rightarrow \text{es existiert} \ k\ \geq n+1$ sodass};
	% Text Node
	\draw (85,288) node    {$\mathcal{M}_{n}$};
	% Text Node
	\draw (140,378) node    {$A=A_{k}$};
	% Text Node
	\draw (239,346.02) node    {$B\ $};
	% Text Node
	\draw (177,259) node    {$H_{n}( k)$};
	...
	\draw (199,379) node    {$f_{n,k}$};
	% Text Node
	\draw (439,332) node   [align=left] {$\displaystyle  \begin{array}{{>{\displaystyle}c}}
		\Rightarrow B_{k} \ \underset{\text{"uber} \ A}{\hookrightarrow } &{H_{n+1}( k)}\\
		&\cap \\
		&{H_{n+2}( k)}\\
		&\cap \\
		&\vdots \\
		\mathcal{M}_{k+1} \ &{H_{k}( k)}
		\end{array}$};
	% Connection
	\draw    (93,145.34) -- (188.09,116.54) ;
	\draw [shift={(190,115.96)}, rotate = 523.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(93,145.34)}, rotate = 343.15] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (179,365.4) -- (225.6,350.35) ;
	\draw [shift={(227.5,349.74)}, rotate = 522.1] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
	\draw [shift={(179,365.4)}, rotate = 342.1] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]      (0,-11.18) .. controls (-3.09,-11.18) and (-5.59,-8.68) .. (-5.59,-5.59) .. controls (-5.59,-2.5) and (-3.09,0) .. (0,0) ;
	% Connection
	\draw    (132.06,365) -- (92.94,301) ;
...
\end{proof}
\begin{corollary}
	Wenn die Sprache endlich ist und nur aus Konstanten- und Relationszeichen besteht, ist die Theorie des Fra"issélimes $\aleph_0$-kategorisch.
\end{corollary}

%Sitzung 20 9.1.2020
\begin{proof}
	Wegen \nameref{rn} gen"ugt es zu zeigen, dass die Theorie $T = \Th(\underbrace{\scrM}_{\text{Fra"issélimes}})$ Quantorenelimination besitzt.
...
\begin{example}
	\begin{itemize}
		\item jede konstante Folge ist immer "uber jeder Menge ununterscheidbar!
		\item $T = \exists^\infty$ 
		...
		%Shape: Ellipse [id:dp3426260465311449] 
		\draw   (10,167.5) .. controls (10,137.95) and (46.26,114) .. (91,114) .. controls (135.74,114) and (172,137.95) .. (172,167.5) .. controls (172,197.05) and (135.74,221) .. (91,221) .. controls (46.26,221) and (10,197.05) .. (10,167.5) -- cycle ;
		%Shape: Ellipse [id:dp9087071352381062] 
		\draw   (46,162) .. controls (46,143.77) and (55.18,129) .. (66.5,129) .. controls (77.82,129) and (87,143.77) .. (87,162) .. controls (87,180.23) and (77.82,195) .. (66.5,195) .. controls (55.18,195) and (46,180.23) .. (46,162) -- cycle ;
		
		% Text Node
		\draw (21,112) node    {$\mathcal{M}$};
		% Text Node
		\draw (66.5,162) node  [font=\small]  {${\textstyle a_{1} =b}$};
		% Text Node
		\draw (83,202) node    {$B$};
		% Text Node
		\draw (233,167.5) node    {$\rightsquigarrow \text{konstant}$};
		...
		\draw (83,202) node    {$B$};
		% Text Node
		\draw (105,136) node  [font=\small]  {$a_{1}$};
		% Text Node
		\draw (117,167.5) node  [font=\small]  {$a_{3}$};
		% Text Node
		\draw (130,141) node  [font=\small]  {$a_{2}$};
		% Text Node
		\draw (130,189) node  [font=\small]  {$a_{5}$};
		% Text Node
		\draw (108,188) node  [font=\small]  {$a_{4}$};
		...
		\draw (83,202) node    {$B$};
		% Text Node
		\draw (316,167.5) node    {$ \begin{array}{l}
			\text{Formel in 2 Variablen:} \ ( x_{1} =x_{2})\\
			\rightsquigarrow \text{konstant}
			\end{array}$};
		% Text Node
		\draw (124,167.5) node  [font=\small]  {$a_{1} =a_{2}$};
		
		
		\end{tikzpicture}
		\item $T = \dlo$. Betrachte $\setQ$ mit $B=\emptyset$ 
		...
		%Straight Lines [id:da5201362407401574] 
		\draw    (34,167.5) -- (429,167.5) (44,163.5) -- (44,171.5)(54,163.5) -- (54,171.5)(64,163.5) -- (64,171.5)(74,163.5) -- (74,171.5)(84,163.5) -- (84,171.5)(94,163.5) -- (94,171.5)(104,163.5) -- (104,171.5)(114,163.5) -- (114,171.5)(124,163.5) -- (124,171.5)(134,163.5) -- (134,171.5)(144,163.5) -- (144,171.5)(154,163.5) -- (154,171.5)(164,163.5) -- (164,171.5)(174,163.5) -- (174,171.5)(184,163.5) -- (184,171.5)(194,163.5) -- (194,171.5)(204,163.5) -- (204,171.5)(214,163.5) -- (214,171.5)(224,163.5) -- (224,171.5)(234,163.5) -- (234,171.5)(244,163.5) -- (244,171.5)(254,163.5) -- (254,171.5)(264,163.5) -- (264,171.5)(274,163.5) -- (274,171.5)(284,163.5) -- (284,171.5)(294,163.5) -- (294,171.5)(304,163.5) -- (304,171.5)(314,163.5) -- (314,171.5)(324,163.5) -- (324,171.5)(334,163.5) -- (334,171.5)(344,163.5) -- (344,171.5)(354,163.5) -- (354,171.5)(364,163.5) -- (364,171.5)(374,163.5) -- (374,171.5)(384,163.5) -- (384,171.5)(394,163.5) -- (394,171.5)(404,163.5) -- (404,171.5)(414,163.5) -- (414,171.5)(424,163.5) -- (424,171.5) ;
		
		
		
		% Text Node
		\draw (170,180.5) node    {$a_{0}$};
		% Text Node
		\draw (128,180.5) node    {$a_{1}$};
		% Text Node
		\draw (87,180.5) node    {$a_{2}$};
...
%PRUEFUNGSRELEVANT
\begin{remark}
	Sei $\varphi[x_1, \dots, x_n]$ eine Formel, sodass $\{m \in M \mid \scrM \models \varphi[a_1, \dots, a_{n-1},m] \}$ endlich. Sei au"serdem $(a_i)_{i \in \setN}$ eine ununterscheidbare Folge mit $\scrM \models \varphi[a_1, \dots, a_{n-1}] \Rightarrow {a_k = a_l},~ {k,l \in \setN}$
\end{remark}
\heading{Ziel:} \begin{theorem}
	Sei $T$ eine vollst"andige Theorie mit unendlichen Modellen. Dann gibt es f"ur jede lineare Ordnung $I$ ein Modell $\scrM \models T$ und eine nicht-triviale ununterscheidbare Folge $(a_1)_{i \in I}$ in $\scrM$.
\end{theorem}
Daf"ur brauchen wir den Satz von Ramsey:
\begin{theorem}[Ramsey]\label{rams}
	Sei $A$ unendliche Menge, $n \in \setN$, $[A]^n = \{n$-elementige Teilmengen von $A \}$. Gegeben eine endliche Zerlegung $[A]^n = \bigcup\limits_{i=1}^k C_i$ in endliche Farben, gibt es eine unendliche Teilmenge $A_0 \subset A$ mit $[A_0]^n$ monochrom.
\end{theorem}
%SITZUNG X 21.01.2020
\begin{proof}
...
\begin{proof}
	...
	Aus dem Satz von \nameref{rams} gibt es eine monochrome unendliche Teilmenge $A_0$ von $A$.
\end{proof}
\begin{corollary}
...
\begin{proof}
	...
	Es gibt eine Menge $\left(b_\alpha\right)_{\alpha<\aleph_1}$ von Realisierungen verschiedener Typen "uber $A$ (in $\scrM$). Wegen \nameref{ls:ab} gibt es $A \cup \left\{b_\alpha \right\}_{\alpha<\aleph_1} \subseteq \tilde\scrM \underset{\text{in}~\scrL_A}{\preceq} \scrM$ mit $|\tilde{M}| = \aleph_1$.\\
	Wegen \nameref{ls:auf} gibt es $\tilde\scrN \underset{\scrL_A}{\preceq} \scrN$ der M"achtigkeit $\kappa > \aleph_0$.\\
	$\scrN$ ist bis auf Isomorphie das einzige Modell von $T$ der M"achtigkeit $\kappa$! Widerspruch zu Satz \nameref{abz}, da dieser abz"ahlbar viele Typen fordert.
\end{proof}
...
\begin{proof}
	...
	Wegen \nameref{ls:auf} und \nameref{ls:ab} gibt es ein $\scrM \models T$ der M"achtigkeit $\aleph_1$. Insbesondere: $T$ $\omega$-stabil $\Rightarrow$ total transzendent $\Rightarrow~ \aleph_1$-stabil\\
...
\begin{proof}
	...
	Aber $\scrM \equiv \scrN$, saturiert nach Voraussetzung $\Rightarrow$ $\scrM \simeq \scrN$ nach VL (konstruiere ein Back-\&-Forth-System)%TODO Referenz
...
\begin{example}
	\begin{itemize}
		...
		\item $\scrL = \left\{P\right\}$. %TODO Bilder
...
\end{remark}
\begin{proof}
	Sonst: Widerspruch mit \nameref{ls:ab}: $\varphi(M) \leq \scrN \preceq \scrM$ \& $\underbrace{|N|}_{< |M|} \leq \max\left\{\aleph_0, |\varphi(M)|\right\}~ \rightarrow$ Vaught'sches Paar, denn $\varphi(M) = \varphi(N)$.
\end{proof}
\begin{definition}
...
\begin{example}
	\begin{itemize}
		...
		\item $E$ "Aquivalenzrelation. $T$: %TODO Grafik
...
\begin{proof}
	...
	\underline{\nameref{test}}: Sei $\psi$ eine $\scrL$-Formel. $\scrN \models \Exists x \psi[x, b_1, \dots, b_m], b_1, \dots, b_m \in P^\scrN$. $\zz$es gibt ein $b \in P^\scrN \mid \scrN \models \psi[b,b_1, \dots, b_m]$.
